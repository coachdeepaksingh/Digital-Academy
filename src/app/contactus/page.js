...
export default function ContactUs() {
  return (
    <div>
      ...
      <section class="relative flex items-top justify-center min-h-[60vh] bg-white dark:bg-gray-900 sm:items-center sm:pt-0">
        <div class="w-[98%] mx-auto sm:px-8">
            <div class="my-3 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 p-5">
                    ...
                    <form class="p-6 flex flex-col justify-center bg-amber-500">
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <textarea type="text" name="msg" id="msg" placeholder="Write your message..." class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"/>
                        </div>

                        <button type="submit" class="md:w-32 bg-white hover:bg-blue-dark text-black font-bold py-3 px-6 rounded-lg mt-3 hover:bg-gray-200 transition ease-in-out duration-300">
                            SUBMIT
                        </button>
                    </form>
                </div>
